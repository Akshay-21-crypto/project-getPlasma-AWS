...
class RecipientRegistrationForm extends React.Component {
    constructor() {
        super()
        this.state = {
            name:"",
            ...
            UserPool.signUp(email,password,att, null, (err, data) => {
              if (err) {
                ...
                const recipientDetails = {
                    ...
                    dateOfRequest:this.state.dateOfRegistration,
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <Form.Row>
                        ...
                        <Form.Group as={Col} controlId="formDetailsBloodGroup">
                            ...
                            <Form.Control as="select" name="bloodGroup" value={this.state.bloodGroup} onChange={this.handleChange} >
                    ...
                    <Form.Group controlId="formDetailsHospitalAddress">
                        <Form.Label>Hospital Address</Form.Label><br />
                        <textarea name="hospitalAddress" rows="3" cols="50" value={this.state.hospitalAddress} onChange={this.handleChange} />
                    </Form.Group>

                    <Form.Row>
                        <Form.Group as={Col} controlId="formDetailsCity">
                            <Form.Label>City</Form.Label>
                            <Form.Control as="select" name="city" value={this.state.city} onChange={this.handleChange} >
                                <option style={{display:'none'}}>select</option>
                    ...
                    <Form.Row>
                        <Form.Group as={Col} controlId="formDetailsPositiveDate">
                            ...
                            <Form.Control type="date" name="covidPosDate" value={this.state.covidPosDate} onChange={this.handleChange} />
                        </Form.Group>

                        <Form.Group as={Col} controlId="formDetailsPhone">
                    ...
                    <Form.Group controlId="formDetailsSubmit">
                        <Button as="input" variant="secondary" type="submit" value="Register as Recipient"  />
                    </Form.Group>
                </Form>
            </div>
        )
